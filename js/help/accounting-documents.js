...
orbitScreenHelp({
  ...
  "inv.out": {
    ...
    buttons: [
      ...
      ["+ Add a line", "Adds an empty line. The x at the end of a line removes it. You can also press <b>Enter</b> on the last box of the last line: that adds the line and puts the cursor in its first box, so you never stop typing."],
      ...
      ["&#171; &#8249; &#8250; &#187;", "Four buttons beside the invoice number when you opened it from the list. Step to the first, previous, next or last invoice in the list's order, with its search and filters, without going back to it. Alt with the left or right arrow key steps one at a time, Alt+Home and Alt+End jump to the two ends, and <i>3 of 40</i> shows where you are."],
      ...
      ["Mirror in the other company", "Shown on a posted invoice when the customer is tagged as one of your own companies. Creates the matching vendor bill as a draft in that company, for the same lines and total, and marks this invoice's entry as intercompany. Each line's tax and account are matched to that company's own (tax by name then by the same rate, account by code then by name), so the copy posts the same figure. Anything it cannot match is named before you confirm, and that line goes across without it."],
  ...
  "pay.in": {
    ...
    buttons: [
      ...
      ["&#171; &#8249; &#8250; &#187;", "Four buttons beside the payment's title when you opened it from the list. Step to the first, previous, next or last payment in the list's order. Alt with the left or right arrow key steps one at a time, Alt+Home and Alt+End jump to the two ends, and <i>3 of 40</i> shows where you are."],
  ...
  "inv.in": {
    ...
    buttons: [
      ...
      ["&#171; &#8249; &#8250; &#187;", "Four buttons beside the bill number when you opened it from the list. Step to the first, previous, next or last bill in the list's order, with its search and filters, without going back to it. Alt with the left or right arrow key steps one at a time, Alt+Home and Alt+End jump to the two ends, and <i>3 of 40</i> shows where you are."],
      ["Mirror in the other company", "Only on a posted bill whose vendor is tagged as one of your own companies. Creates the matching customer invoice in that company as a draft, so group reports can cancel the pair out. Each line's tax and account are matched to that company's own, and anything it cannot match is named before you confirm."],
