...
orbitScreenHelp({
  ...
  "cash.moves": {
    ...
    buttons: [
      ...
      ["&#171; &#8249; &#8250; &#187;", "Four buttons beside the movement number when you opened it from this list. Step to the first, previous, next or last movement in the list's order, with its search and filters, without closing the dialog. Alt with the left or right arrow key steps one at a time, Alt+Home and Alt+End jump to the two ends, and <i>3 of 40</i> shows where you are."],
