// GENERATED single-file Worker for the Cloudflare dashboard (orbit-sites).
// = functions/site/render-core.js + worker/index.js (import stripped). Regenerate on change.
